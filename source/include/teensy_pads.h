...
#else
enum TEENSY_PAD_34_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_B1_13
    TEENSY_PAD_34_MODE_WDOG1_B = 0,
    TEENSY_PAD_34_MODE_LPUART5_RX,
    TEENSY_PAD_34_MODE_CSI_VSYNC,
    TEENSY_PAD_34_MODE_ENET_1588_EVENT0_OUT,
    TEENSY_PAD_34_MODE_FLEXIO2_FLEXIO29,
    TEENSY_PAD_34_MODE_GPIO2_IO29,
    TEENSY_PAD_34_MODE_USDHC1_WP,
    TEENSY_PAD_34_MODE_SEMC_DQS4 = 8,
    TEENSY_PAD_34_MODE_FLEXIO3_FLEXIO29
};

enum TEENSY_PAD_35_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_B1_12
    TEENSY_PAD_35_MODE_LPUART5_TX = 1,
    TEENSY_PAD_35_MODE_CSI_PIXCLK,
    TEENSY_PAD_35_MODE_ENET_1588_EVENT0_IN,
    TEENSY_PAD_35_MODE_FLEXIO2_FLEXIO28,
    TEENSY_PAD_35_MODE_GPIO2_IO28,
    TEENSY_PAD_35_MODE_USDHC1_CD_B,
    TEENSY_PAD_35_MODE_FLEXIO3_FLEXIO28 = 9
};

enum TEENSY_PAD_36_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_B1_02
    TEENSY_PAD_36_MODE_LCD_DATA14 = 0,
    TEENSY_PAD_36_MODE_XBAR1_INOUT16,
    TEENSY_PAD_36_MODE_LPSPI4_PCS2,
    TEENSY_PAD_36_MODE_SAI1_TX_BCLK,
    TEENSY_PAD_36_MODE_FLEXIO2_FLEXIO18,
    TEENSY_PAD_36_MODE_GPIO2_IO18,
    TEENSY_PAD_36_MODE_FLEXPWM2_PWMA03,
    TEENSY_PAD_36_MODE_ENET2_RDATA01 = 8,
    TEENSY_PAD_36_MODE_FLEXIO3_FLEXIO18
};

enum TEENSY_PAD_37_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_B1_03
    TEENSY_PAD_37_MODE_LCD_DATA15 = 0,
    TEENSY_PAD_37_MODE_XBAR1_INOUT17,
    TEENSY_PAD_37_MODE_LPSPI4_PCS1,
    TEENSY_PAD_37_MODE_SAI1_TX_SYNC,
    TEENSY_PAD_37_MODE_FLEXIO2_FLEXIO19,
    TEENSY_PAD_37_MODE_GPIO2_IO19,
    TEENSY_PAD_37_MODE_FLEXPWM2_PWMB03,
    TEENSY_PAD_37_MODE_ENET2_RX_EN = 8,
    TEENSY_PAD_37_MODE_FLEXIO3_FLEXIO19
};

enum TEENSY_PAD_38_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_AD_B1_12
    TEENSY_PAD_38_MODE_FLEXSPIA_DATA01 = 0,
    TEENSY_PAD_38_MODE_ACMP_OUT00,
    TEENSY_PAD_38_MODE_LPSPI3_PCS0,
    TEENSY_PAD_38_MODE_SAI1_RX_DATA00,
    TEENSY_PAD_38_MODE_CSI_DATA05,
    TEENSY_PAD_38_MODE_GPIO1_IO28,
    TEENSY_PAD_38_MODE_USDHC2_DATA4,
    TEENSY_PAD_38_MODE_KPP_ROW01,
    TEENSY_PAD_38_MODE_ENET2_1588_EVENT2_OUT,
    TEENSY_PAD_38_MODE_FLEXIO3_FLEXIO12
};

enum TEENSY_PAD_39_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_AD_B1_13
    TEENSY_PAD_39_MODE_FLEXSPIA_DATA00 = 0,
    TEENSY_PAD_39_MODE_ACMP_OUT01,
    TEENSY_PAD_39_MODE_LPSPI3_SDI,
    TEENSY_PAD_39_MODE_SAI1_TX_DATA00,
    TEENSY_PAD_39_MODE_CSI_DATA04,
    TEENSY_PAD_39_MODE_GPIO1_IO29,
    TEENSY_PAD_39_MODE_USDHC2_DATA5,
    TEENSY_PAD_39_MODE_KPP_COL01,
    TEENSY_PAD_39_MODE_ENET2_1588_EVENT2_IN,
    TEENSY_PAD_39_MODE_FLEXIO3_FLEXIO13
};

enum TEENSY_PAD_40_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_AD_B1_04
    TEENSY_PAD_40_MODE_FLEXSPIB_DATA03 = 0,
    TEENSY_PAD_40_MODE_ENET_MDC,
    TEENSY_PAD_40_MODE_LPUART3_CTS_B,
    TEENSY_PAD_40_MODE_SPDIF_SR_CLK,
    TEENSY_PAD_40_MODE_CSI_PIXCLK,
    TEENSY_PAD_40_MODE_GPIO1_IO20,
    TEENSY_PAD_40_MODE_USDHC2_DATA0,
    TEENSY_PAD_40_MODE_KPP_ROW05,
    TEENSY_PAD_40_MODE_GPT2_CAPTURE2,
    TEENSY_PAD_40_MODE_FLEXIO3_FLEXIO04
};

enum TEENSY_PAD_41_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_AD_B1_05
    TEENSY_PAD_41_MODE_FLEXSPIB_DATA02 = 0,
    TEENSY_PAD_41_MODE_ENET_MDIO,
    TEENSY_PAD_41_MODE_LPUART3_RTS_B,
    TEENSY_PAD_41_MODE_SPDIF_OUT,
    TEENSY_PAD_41_MODE_CSI_MCLK,
    TEENSY_PAD_41_MODE_GPIO1_IO21,
    TEENSY_PAD_41_MODE_USDHC2_DATA1,
    TEENSY_PAD_41_MODE_KPP_COL05,
    TEENSY_PAD_41_MODE_GPT2_COMPARE1,
    TEENSY_PAD_41_MODE_FLEXIO3_FLEXIO05
};

enum TEENSY_PAD_42_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_SD_B0_03
    TEENSY_PAD_42_MODE_USDHC1_DATA1 = 0,
    TEENSY_PAD_42_MODE_FLEXPWM1_PWMB01,
    TEENSY_PAD_42_MODE_LPUART8_RTS_B,
    TEENSY_PAD_42_MODE_XBAR1_INOUT07,
    TEENSY_PAD_42_MODE_LPSPI1_SDI,
    TEENSY_PAD_42_MODE_GPIO3_IO15,
    TEENSY_PAD_42_MODE_ENET2_RDATA00 = 8,
    TEENSY_PAD_42_MODE_SEMC_CLK6
};

enum TEENSY_PAD_43_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_SD_B0_02
    TEENSY_PAD_43_MODE_USDHC1_DATA0 = 0,
    TEENSY_PAD_43_MODE_FLEXPWM1_PWMA01,
    TEENSY_PAD_43_MODE_LPUART8_CTS_B,
    TEENSY_PAD_43_MODE_XBAR1_INOUT06,
    TEENSY_PAD_43_MODE_LPSPI1_SDO,
    TEENSY_PAD_43_MODE_GPIO3_IO14,
    TEENSY_PAD_43_MODE_ENET2_RX_ER = 8,
    TEENSY_PAD_43_MODE_SEMC_CLK5
};

enum TEENSY_PAD_44_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_SD_B0_01
    TEENSY_PAD_44_MODE_USDHC1_CLK = 0,
    TEENSY_PAD_44_MODE_FLEXPWM1_PWMB00,
    TEENSY_PAD_44_MODE_LPI2C3_SDA,
    TEENSY_PAD_44_MODE_XBAR1_INOUT05,
    TEENSY_PAD_44_MODE_LPSPI1_PCS0,
    TEENSY_PAD_44_MODE_GPIO3_IO13,
    TEENSY_PAD_44_MODE_FLEXSPIB_SS1_B,
    TEENSY_PAD_44_MODE_ENET2_TX_CLK = 8,
    TEENSY_PAD_44_MODE_ENET2_REF_CLK2
};

enum TEENSY_PAD_45_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_SD_B0_00
    TEENSY_PAD_45_MODE_USDHC1_CMD = 0,
    TEENSY_PAD_45_MODE_FLEXPWM1_PWMA00,
    TEENSY_PAD_45_MODE_LPI2C3_SCL,
    TEENSY_PAD_45_MODE_XBAR1_INOUT04,
    TEENSY_PAD_45_MODE_LPSPI1_SCK,
    TEENSY_PAD_45_MODE_GPIO3_IO12,
    TEENSY_PAD_45_MODE_FLEXSPIA_SS1_B,
    TEENSY_PAD_45_MODE_ENET2_TX_EN = 8,
    TEENSY_PAD_45_MODE_SEMC_DQS4
};

enum TEENSY_PAD_46_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_SD_B0_05
    TEENSY_PAD_46_MODE_USDHC1_DATA3 = 0,
    TEENSY_PAD_46_MODE_FLEXPWM1_PWMB02,
    TEENSY_PAD_46_MODE_LPUART8_RX,
    TEENSY_PAD_46_MODE_XBAR1_INOUT09,
    TEENSY_PAD_46_MODE_FLEXSPIB_DQS,
    TEENSY_PAD_46_MODE_GPIO3_IO17,
    TEENSY_PAD_46_MODE_CCM_CLKO2,
    TEENSY_PAD_46_MODE_ENET2_RX_EN = 8
};

enum TEENSY_PAD_47_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_SD_B0_04
    TEENSY_PAD_47_MODE_USDHC1_DATA2 = 0,
    TEENSY_PAD_47_MODE_FLEXPWM1_PWMA02,
    TEENSY_PAD_47_MODE_LPUART8_TX,
    TEENSY_PAD_47_MODE_XBAR1_INOUT08,
    TEENSY_PAD_47_MODE_FLEXSPIB_SS0_B,
    TEENSY_PAD_47_MODE_GPIO3_IO16,
    TEENSY_PAD_47_MODE_CCM_CLKO1,
    TEENSY_PAD_47_MODE_ENET2_RDATA01 = 8
};

enum TEENSY_PAD_48_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_EMC_24
    TEENSY_PAD_48_MODE_SEMC_CAS = 0,
    TEENSY_PAD_48_MODE_FLEXPWM1_PWMB00,
    TEENSY_PAD_48_MODE_LPUART5_RX,
    TEENSY_PAD_48_MODE_ENET_TX_EN,
    TEENSY_PAD_48_MODE_GPT1_CAPTURE1,
    TEENSY_PAD_48_MODE_GPIO4_IO24,
    TEENSY_PAD_48_MODE_FLEXSPI2_A_SS0_B = 8
};

enum TEENSY_PAD_49_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_EMC_27
    TEENSY_PAD_49_MODE_SEMC_CKE = 0,
    TEENSY_PAD_49_MODE_FLEXPWM1_PWMA02,
    TEENSY_PAD_49_MODE_LPUART5_RTS_B,
    TEENSY_PAD_49_MODE_LPSPI1_SCK,
    TEENSY_PAD_49_MODE_FLEXIO1_FLEXIO13,
    TEENSY_PAD_49_MODE_GPIO4_IO27,
    TEENSY_PAD_49_MODE_FLEXSPI2_A_DATA01 = 8
};

enum TEENSY_PAD_50_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_EMC_28
    TEENSY_PAD_50_MODE_SEMC_WE = 0,
    TEENSY_PAD_50_MODE_FLEXPWM1_PWMB02,
    TEENSY_PAD_50_MODE_LPUART5_CTS_B,
    TEENSY_PAD_50_MODE_LPSPI1_SDO,
    TEENSY_PAD_50_MODE_FLEXIO1_FLEXIO14,
    TEENSY_PAD_50_MODE_GPIO4_IO28,
    TEENSY_PAD_50_MODE_FLEXSPI2_A_DATA02 = 8
};

enum TEENSY_PAD_51_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_EMC_22
    TEENSY_PAD_51_MODE_SEMC_BA1 = 0,
    TEENSY_PAD_51_MODE_FLEXPWM3_PWMB03,
    TEENSY_PAD_51_MODE_LPI2C3_SCL,
    TEENSY_PAD_51_MODE_ENET_TDATA00,
    TEENSY_PAD_51_MODE_QTIMER2_TIMER3,
    TEENSY_PAD_51_MODE_GPIO4_IO22,
    TEENSY_PAD_51_MODE_FLEXSPI2_A_SS1_B = 8
};

enum TEENSY_PAD_52_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_EMC_26
    TEENSY_PAD_52_MODE_SEMC_CLK = 0,
    TEENSY_PAD_52_MODE_FLEXPWM1_PWMB01,
    TEENSY_PAD_52_MODE_LPUART6_RX,
    TEENSY_PAD_52_MODE_ENET_RX_ER,
    TEENSY_PAD_52_MODE_FLEXIO1_FLEXIO12,
    TEENSY_PAD_52_MODE_GPIO4_IO26,
    TEENSY_PAD_52_MODE_FLEXSPI2_A_DATA00 = 8
};

enum TEENSY_PAD_53_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_EMC_25
    TEENSY_PAD_53_MODE_SEMC_RAS = 0,
    TEENSY_PAD_53_MODE_FLEXPWM1_PWMA01,
    TEENSY_PAD_53_MODE_LPUART6_TX,
    TEENSY_PAD_53_MODE_ENET_TX_CLK,
    TEENSY_PAD_53_MODE_ENET_REF_CLK,
    TEENSY_PAD_53_MODE_GPIO4_IO25,
    TEENSY_PAD_53_MODE_FLEXSPI2_A_SCLK = 8
};

enum TEENSY_PAD_54_MODES { // IOMUXC_SW_MUX_CTL_PAD_GPIO_EMC_29
    TEENSY_PAD_54_MODE_SEMC_CS0 = 0,
    TEENSY_PAD_54_MODE_FLEXPWM3_PWMA00,
    TEENSY_PAD_54_MODE_LPUART6_RTS_B,
    TEENSY_PAD_54_MODE_LPSPI1_SDI,
    TEENSY_PAD_54_MODE_FLEXIO1_FLEXIO15,
    TEENSY_PAD_54_MODE_GPIO4_IO29,
    TEENSY_PAD_54_MODE_FLEXSPI2_A_DATA03 = 8
};
#endif

...
#define teensy_uart_get_imx_bus(teensy_uartn) teensy_uart_to_imxbus_rx_tx[teensy_uartn][0]
#define teensy_uart_get_rx_pad(teensy_uartn) teensy_uart_to_imxbus_rx_tx[teensy_uartn][1]
#define teensy_uart_get_tx_pad(teensy_uartn) teensy_uart_to_imxbus_rx_tx[teensy_uartn][2]
...
extern uint8_t teensy_uart_to_imxbus_rx_tx[8][3];
